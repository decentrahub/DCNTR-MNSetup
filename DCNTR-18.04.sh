#!/bin/bash
# Decentrahub Coin Masternode Setup Script V1.0 for Ubuntu 18.04 LTS
#
...
wget https://github.com/decentrahub/DecentrahubCoin/releases/download/v1.0/Decentrahub-daemon-ubuntu-18.04.tar.gz
tar -xzvf Decentrahub-daemon-ubuntu-18.04.tar.gz
